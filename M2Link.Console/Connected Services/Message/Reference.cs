...
namespace M2Link.Console.Message {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="Message.IWSMessage")]
    public interface IWSMessage {
        ...
        M2Link.Console.Message.MessageModel[] GetMessages(System.Guid user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWSMessage/GetMessages", ReplyAction="http://tempuri.org/IWSMessage/GetMessagesResponse")]
        System.Threading.Tasks.Task<M2Link.Console.Message.MessageModel[]> GetMessagesAsync(System.Guid user);
        ...
        M2Link.Console.Message.MessageModel CreateMessage(System.Guid user, string messageContent);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWSMessage/CreateMessage", ReplyAction="http://tempuri.org/IWSMessage/CreateMessageResponse")]
        System.Threading.Tasks.Task<M2Link.Console.Message.MessageModel> CreateMessageAsync(System.Guid user, string messageContent);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IWSMessageChannel : M2Link.Console.Message.IWSMessage, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WSMessageClient : System.ServiceModel.ClientBase<M2Link.Console.Message.IWSMessage>, M2Link.Console.Message.IWSMessage {
        ...
        public M2Link.Console.Message.MessageModel[] GetMessages(System.Guid user) {
            return base.Channel.GetMessages(user);
        }
        
        public System.Threading.Tasks.Task<M2Link.Console.Message.MessageModel[]> GetMessagesAsync(System.Guid user) {
            return base.Channel.GetMessagesAsync(user);
        }
        
        public M2Link.Console.Message.MessageModel CreateMessage(System.Guid user, string messageContent) {
            return base.Channel.CreateMessage(user, messageContent);
        }
        
        public System.Threading.Tasks.Task<M2Link.Console.Message.MessageModel> CreateMessageAsync(System.Guid user, string messageContent) {
