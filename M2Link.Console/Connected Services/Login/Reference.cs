...
namespace M2Link.Console.Login {
    ...
    public interface IWSLogin {
        ...
        M2Link.Console.Login.UserModel Validate(string nom, string mdp);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWSLogin/Validate", ReplyAction="http://tempuri.org/IWSLogin/ValidateResponse")]
        System.Threading.Tasks.Task<M2Link.Console.Login.UserModel> ValidateAsync(string nom, string mdp);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IWSLoginChannel : M2Link.Console.Login.IWSLogin, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WSLoginClient : System.ServiceModel.ClientBase<M2Link.Console.Login.IWSLogin>, M2Link.Console.Login.IWSLogin {
        ...
        public M2Link.Console.Login.UserModel Validate(string nom, string mdp) {
            return base.Channel.Validate(nom, mdp);
        }
        
        public System.Threading.Tasks.Task<M2Link.Console.Login.UserModel> ValidateAsync(string nom, string mdp) {
