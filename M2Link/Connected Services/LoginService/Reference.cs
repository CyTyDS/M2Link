...
namespace M2Link.LoginService {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="LoginService.IWSLogin")]
    public interface IWSLogin {
        ...
        M2Link.LoginService.UserModel Validate(string nom, string mdp);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWSLogin/Validate", ReplyAction="http://tempuri.org/IWSLogin/ValidateResponse")]
        System.Threading.Tasks.Task<M2Link.LoginService.UserModel> ValidateAsync(string nom, string mdp);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IWSLoginChannel : M2Link.LoginService.IWSLogin, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WSLoginClient : System.ServiceModel.ClientBase<M2Link.LoginService.IWSLogin>, M2Link.LoginService.IWSLogin {
        ...
        public M2Link.LoginService.UserModel Validate(string nom, string mdp) {
            return base.Channel.Validate(nom, mdp);
        }
        
        public System.Threading.Tasks.Task<M2Link.LoginService.UserModel> ValidateAsync(string nom, string mdp) {
